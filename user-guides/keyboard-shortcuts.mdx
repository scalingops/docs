...
| Global Search | `Ctrl+K` | `⌘K` | Open the global search command palette |
| Toggle Filters | `Ctrl+Shift+F` | `⌘⇧F` | Show/hide the filter panel |
| Navigate Modules | `Alt+[1-9]` | `⌥[1-9]` | Quick navigation to module by number |
| Switch Companies | `Ctrl+Shift+C` | `⌘⇧C` | Open company switcher |
...
| Action | Windows/Linux | Mac | Description |
|--------|--------------|-----|-------------|
| Focus Search | `/` | `/` | Quick focus on search input |
