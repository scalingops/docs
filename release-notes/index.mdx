...
- **Learning Paths with unsaved changes protection**: Enhanced learning path editor with automatic draft saving and warning dialogs to prevent accidental loss of work when navigating away.
...
- **M365 Secure Score bulk operations**: Add multiple security controls to meetings and planner with one click, including automatic AI summaries for bulk additions.
...
- **Training course image optimization**: Public bucket storage for training images with smart fallbacks for faster loading and better reliability.
